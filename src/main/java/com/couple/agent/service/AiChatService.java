...
public interface AiChatService {
     ...
     * @return 流式事件流
     */
    Flux<StreamChatEvent> streamChat(Long userId, Long conversationId, String content,
     ...
     * @return AI 响应内容
     */
    String chat(Long userId, Long conversationId, String content, String modelCode);
}
